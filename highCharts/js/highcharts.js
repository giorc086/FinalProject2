...
(function(C, Z) { typeof module === "object" && module.exports ? module.exports = C.document ? Z(C) : Z : C.Highcharts = Z(C) })(typeof window !== "undefined" ? window : this, function(C) {
    ...
    function qb(a, b, c) { this.options = b;
        this.elem = a;
        this.prop = c }
    ...
    function Ta(a,
        b) { b.renderer.globalAnimation = p(a, b.animation) }
    ...
    qb.prototype = {
        ...
        run: function(a, b, c) {
            ...
            if (e() && Ha.push(e) === 1) e.timerId = setInterval(function() {
                ...
                Ha.length || clearInterval(e.timerId) }, 13)
        },
        step: function(a) {
            var b = +new pa,
                c, d = this.options;
    ...
    Pa = function(a, b, c) {
        ...
        var a = p(a, "%Y-%m-%d %H:%M:%S"),
            ...
            l = j.weekdays,
            m = j.shortWeekdays,
            d = s({ a: m ? m[g] : l[g].substr(0, 3), A: l[g], d: Ea(h), e: Ea(h, 2, " "), w: g, b: j.shortMonths[i], B: j.months[i], m: Ea(i + 1), y: k.toString().substr(2, 2), Y: k, H: Ea(f), k: f, I: Ea(f % 12 || 12), l: f % 12 || 12, M: Ea(d[ub]()), p: f < 12 ? "AM" : "PM", P: f < 12 ? "am" : "pm", S: Ea(d.getSeconds()), L: Ea(B(b % 1E3), 3) }, w.dateFormats);
        for (e in d)
    ...
    Ab = function(a) {
        ...
        return { top: a.top + (C.pageYOffset || b.scrollTop) - (b.clientTop || 0), left: a.left + (C.pageXOffset || b.scrollLeft) - (b.clientLeft || 0) } };
    Na = function(a) {
    ...
    N = function(a, b, c) {
        function d(b) { b.target = b.srcElement || C;
            c.call(a, b) }
        var e = a.hcEvents =
            a.hcEvents || {};
    ...
    S = {
        ...
        global: { useUTC: !0, canvasToolsURL: "http://code.highcharts.com/modules/canvas-tools.js", VMLRadialGradientURL: "http://code.highcharts.com/4.2.4/gfx/vml-radial-gradient.png" },
        ...
        credits: { enabled: !0, text: "Highcharts.com", position: { align: "right", x: -10, verticalAlign: "bottom", y: -5 }, style: { cursor: "pointer", color: "#FFFFFF", fontSize: "9px" } }
    };
    ...
    ja.prototype = {
        parsers: [{
            ...
            parse: function(a) {
                ...
                return [F(a[1], 16), F(a[2], 16), F(a[3], 16), 1] } }, { regex: /rgb\(\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*\)/, parse: function(a) {
        ...
        get: function(a) {
            var b = this.input,
                c = this.rgba,
                d;
            this.stops ? (d = D(b), d.stops = [].concat(d.stops), o(this.stops, function(b, c) { d.stops[c] = [d.stops[c][0], b.get(a)] })) : d = c && !isNaN(c[0]) ? a === "rgb" || !a && c[3] === 1 ? "rgb(" + c[0] + "," + c[1] + "," + c[2] + ")" : a === "a" ? c[3] : "rgba(" + c.join(",") + ")" : b;
            return d },
        brighten: function(a) {
            var b, c = this.rgba;
    ...
    P.prototype = {
        ...
        init: function(a, b) { this.element = b === "span" ? $(b) : A.createElementNS(Ga, b);
            this.renderer = a },
        ...
        colorGradient: function(a, b, c) {
            ...
            if (f) {
                ...
                i[v] ? n = i[v].attr("id") : (g.id = n = "highcharts-" + zb++, i[v] = k = d.createElement(f).attr(g).add(d.defs), k.radAttr = h, k.stops = [],
                    o(j, function(a) { a[1].indexOf("rgba") === 0 ? (e = ja(a[1]), l = e.get("rgb"), m = e.get("a")) : (l = a[1], m = 1);
        ...
        on: function(a, b) {
            var c = this,
                d = c.element;
            db && a === "click" ? (d.ontouchstart = function(a) { c.touchEventFired = pa.now();
                a.preventDefault();
                b.call(d, a) }, d.onclick = function(a) {
                (za.indexOf("Android") === -1 || pa.now() - (c.touchEventFired || 0) > 1100) && b.call(d, a) }) : d["on" + a] = b;
            return this },
        ...
        align: function(a, b, c) {
            ...
            f = e.alignedObjects;
            if (a) {
                if (this.alignOptions = a, this.alignByTranslate = b, !c || xa(c)) this.alignTo = d = c || "renderer", na(f, this), f.push(this), c = null } else a = this.alignOptions, b = this.alignByTranslate, d = this.alignTo;
            c = p(c, e[d], e);
            d = a.align;
            e = a.verticalAlign;
            f = (c.x || 0) + (a.x || 0);
        ...
        getBBox: function(a, b) {
            ...
            if (!c) {
                if (h.namespaceURI === Ga || d.forExport) {
                    try { l = this.fakeTS && function(a) { o(h.querySelectorAll(".highcharts-text-shadow"), function(b) { b.style.display = a }) }, La && j.textShadow ? (k = j.textShadow, j.textShadow = "") : l && l("none"), c = h.getBBox ? s({}, h.getBBox()) : { width: h.offsetWidth, height: h.offsetHeight }, k ? j.textShadow = k : l && l("") } catch (v) {}
    ...
    P.prototype["stroke-widthSetter"] = P.prototype.strokeSetter = function(a, b, c) { this[b] = a;
    ...
    Ca.prototype = {
        ...
        init: function(a, b, c, d, e, f) {
            ...
            if (La && a.getBoundingClientRect) this.subPixelFix = b = function() { L(a, { left: 0, top: 0 });
                ...
                L(a, { left: ua(h.left) - h.left + "px", top: ua(h.top) - h.top + "px" }) }, b(), N(C, "resize", b)
        },
        getStyle: function(a) {
        ...
        buildText: function(a) {
            for (var b = a.element, c = this, d = c.forExport, e = p(a.textStr, "").toString(), f = e.indexOf("<") !== -1,
                    g = b.childNodes, h, i, k = K(b, "x"), j = a.styles, l = a.textWidth, m = j && j.lineHeight, n = j && j.textShadow, q = j && j.textOverflow === "ellipsis", v = g.length, y = l && !a.added && this.box, sa = function(a) {
                        return m ? F(m) : c.fontMetrics(/(px|em)$/.test(a && a.style.fontSize) ? a.style.fontSize : j && j.fontSize || c.style.fontSize || 12, a).h }, x = function(a) {
                        return a.replace(/&lt;/g, "<").replace(/&gt;/g, ">") }; v--;) b.removeChild(g[v]);
        ...
        button: function(a, b, c, d, e, f, g, h, i) {
            ...
            y = h.style;
            delete h.style;
            N(k.element, ya ? "mouseover" : "mouseenter", function() { j !== 3 && k.attr(f).css(q) });
            N(k.element, ya ? "mouseout" : "mouseleave", function() { j !== 3 && (l = [e, f, g][j], m = [n, q, v][j], k.attr(l).css(m)) });
        ...
        crispLine: function(a, b) { a[1] === a[4] && (a[1] = a[4] = B(a[1]) - b % 2 / 2);
        ...
        circle: function(a, b, c) { a = X(a) ? a : { x: a, y: b, r: c };
        ...
        rect: function(a, b, c, d, e, f) {
            var e = X(a) ? a.r : e,
                ...
                a = X(a) ? a : a === z ? {} : { x: a, y: b, width: t(c, 0), height: t(d, 0) };
        ...
        symbol: function(a, b, c, d, e, f) {
            var g = this,
                ...
                k = /^url\((.*?)\)$/,
                j, l;
            if (i) h = this.path(i), s(h, { symbolName: a, x: b, y: c, width: d, height: e }), f && s(h, f);
            else if (k.test(a)) l = function(a, b) { a.element && (a.attr({ width: b[0], height: b[1] }), a.alignByTranslate || a.translate(B((d - b[0]) / 2), B((e - b[1]) / 2))) }, j = a.match(k)[1], a = Mb[j] || f && f.width && f.height && [f.width, f.height], h = this.image(j).attr({ x: b, y: c }), h.isImg = !0, a ? l(h, a) : (h.attr({ width: 0, height: 0 }), $("img", {
                onload: function() {
        ...
        label: function(a, b, c, d, e, f, g, h, i) {
            ...
            j.textSetter = function(a) { a !== z && l.textSetter(a);
                J();
                E() };
            j["stroke-widthSetter"] = function(a, b) { a && (A = !0);
                ob = a % 2 / 2;
                C(b, a) };
            j.strokeSetter = j.fillSetter = j.rSetter = function(a, b) { b === "fill" && a && (A = !0);
                C(b, a) };
            ...
            j.xSetter = function(a) { j.x = a;
                ...
                u = B(a);
                j.attr("translateX", u) };
            j.ySetter = function(a) { t = j.y = B(a);
                j.attr("translateY", t) };
            var F = j.css;
            return s(j, { css: function(a) {
                    if (a) {
                        var b = {},
                            a = D(a);
                        o(j.textProps, function(c) { a[c] !== z && (b[c] = a[c], delete a[c]) });
                        l.css(b) }
                    return F.call(j, a) }, getBBox: function() {
                    return { width: n.width + 2 * v, height: n.height + 2 * v, x: n.x - v, y: n.y - v } }, shadow: function(a) { m && m.shadow(a);
                    return j }, destroy: function() { V(j.element, "mouseenter");
            ...
            if (this.added) {
                ...
                if (b.tagName === "SPAN") {
                    ...
                    if (m !== this.cTT) {
                        ...
                        if (b.offsetWidth > j &&
                            /[ \-]/.test(b.textContent || b.innerText)) L(b, { width: j + "px", display: "block", whiteSpace: l || "normal" }), this.hasTextWidth = !0;
    ...
    s(Ca.prototype, {
        html: function(a, b, c) {
            var d = this.createElement("span"),
                ...
                f = d.renderer,
                g = f.isSVG,
                h = function(a, b) { o(["opacity", "visibility"], function(c) { fb(a, c + "Setter", function(a, c, d, e) { a.call(this, c, d, e);
                            b[d] = c }) }) };
                    ...
                    if (b = a.div, !b) {
                        ...
                        o(g.reverse(), function(a) {
                            var d,
                                e = K(a.element, "class");
                            e && (e = { className: e });
                            b = a.div = a.div || $(Ka, e, { position: "absolute", left: (a.translateX || 0) + "px", top: (a.translateY || 0) + "px", opacity: a.opacity }, b || c);
                            d = b.style;
                            s(a, { translateXSetter: function(b, c) { d.left = b + "px";
                                    a[c] = b;
    ...
    if (!ca && !ia) {
        M = {
            ...
            clip: function(a) {
                ...
                a ? (c = a.members, na(c, b), c.push(b), b.destroyClip =
                    function() { na(c, b) }, a = a.getCSS(b)) : (b.destroyClip && b.destroyClip(), a = { clip: lb ? "inherit" : "rect(auto)" });
                return b.css(a)
            },
            ...
            "fill-opacitySetter": function(a, b, c) { $(this.renderer.prepVML(["<", b.split("-")[0], ' opacity="', a, '"/>']), null, null, c) },
            opacitySetter: Aa,
        ...
        var Bb = {
            ...
            init: function(a, b, c, d) {
                var e;
                this.alignedObjects = [];
                d = this.createElement(Ka).css(s(this.getStyle(d), { position: "relative" }));
                e = d.element;
                ...
                if (!A.namespaces.hcv) { A.namespaces.add("hcv", "urn:schemas-microsoft-com:vml");
                    try { A.createStyleSheet().cssText = "hcv\\:fill, hcv\\:path, hcv\\:shape, hcv\\:stroke{ behavior:url(#default#VML); display: inline-block; } " } catch (f) { A.styleSheets[0].cssText += "hcv\\:fill, hcv\\:path, hcv\\:shape, hcv\\:stroke{ behavior:url(#default#VML); display: inline-block; } " } }
            },
            isHidden: function() {
                ...
                return s(e, {
                    ...
                    getCSS: function(a) {
                        var b = a.element,
                            ...
                            b = e + this.width,
                            f = d + this.height,
                            d = { clip: "rect(" + B(a ? e : d) + "px," + B(a ? f : b) + "px," + B(a ? b : f) + "px," + B(a ? d : e) + "px)" };!a && lb && c === "DIV" && s(d, { width: b + "px", height: f + "px" });
                        return d },
            ...
            color: function(a, b, c, d) {
                ...
                if (i) {
                    var j, l, m = a.linearGradient || a.radialGradient,
                        ...
                        a = a.stops,
                        u, r = [],
                        t = function() { h = ['<fill colors="' + r.join(",") + '" opacity="', v, '" o:opacity2="', q, '" type="', i, '" ', x, 'focus="100%" method="any" />'];
                    ...
                    u[0] < 1 && a.push([1, u[1]]);
                    o(a, function(a, b) { g.test(a[1]) ? (f = ja(a[1]), j = f.get("rgb"), l = f.get("a")) : (j = a[1], l = 1);
                        r.push(a[0] * 100 + "% " + j);
                        b ? (v = l, y = j) : (q = l, p = j) });
                    if (c === "fill")
            ...
            invertChild: function(a, b) {
                ...
                L(a, { flip: "x", left: F(d.width) - (e ? F(e.top) : 1), top: F(d.height) - (e ? F(e.left) : 1), rotation: -90 });
    ...
    Ca.prototype.measureSpanWidth = function(a, b) {
        ...
        return d };
    var Nb;
    if (ia) w.CanVGRenderer = M = function() { Ga = "http://www.w3.org/1999/xhtml" }, M.prototype.symbols = {}, Nb = function() {
        function a() {
            var a = b.length,
                d;
            for (d = 0; d < a; d++) b[d]();
    ...
    Va.prototype = {
        ...
        render: function(a, b, c) {
            var d = this.axis,
                ...
                c = p(c, 1);
            this.isActive = !0;
            if (q) { k = d.getPlotLinePath(k + r, q * s, b, !0);
                if (l === z) { l = { stroke: v, "stroke-width": q };
                    if (y) l.dashstyle = y;
                    if (!h) l.zIndex = 1;
                    if (b) l.opacity = 0;
                    this.gridLine = l = q ? f.path(k).attr(l).add(d.gridGroup) : null }
                if (!b && l && k) l[this.isNew ? "attr" : "animate"]({ d: k, opacity: c }) }
            if (m) d.opposite && (m[0] = -m[0]), h = this.getMarkPath(Y, t, m[0], m[1] * s, g, f), o ? o.animate({ d: h, opacity: c }) : this.mark = f.path(h).attr({
                stroke: n,
                "stroke-width": m[1],
                opacity: c
            }).add(d.axisGroup);
    ...
    w.PlotLineOrBand = function(a, b) { this.axis = a;
    ...
    w.PlotLineOrBand.prototype = {
        render: function() {
            ...
            if (g) {
                if (n = b.getPlotLinePath(j, g), x = { stroke: v, "stroke-width": g }, l) x.dashstyle = l } else if (k) { n = b.getPlotBandPath(i, h, d);
                if (v) x.fill = v;
            ...
            if (m)
                ...
                for (q in d = function(b) { m.on(b, function(c) { o[b].apply(a, [c]) }) }, o) d(q);
            e && r(e.text) && n && n.length && b.width > 0 && b.height > 0 && !n.flat ? (e = D({ align: c && k && "center", x: c ? !k && 4 : 10, verticalAlign: !c && k && "middle", y: c ? k ? 16 : 10 : k ? 6 : -4, rotation: c && !k && 90 }, e), this.renderLabel(e, n, k, y)) : f && f.hide();
            return a
        },
        ...
        destroy: function() { na(this.axis.plotLinesAndBands, this);
            delete this.axis;
            Ra(this) }
    };
    var fa = w.Axis = function() { this.init.apply(this, arguments) };
    fa.prototype = {
        defaultOptions: {
        ...
        defaultYAxisOptions: { endOnTick: !0, gridLineWidth: 1, tickPixelInterval: 72, showLastLabel: !0, labels: { x: -8 }, lineWidth: 0, maxPadding: 0.05, minPadding: 0.05, startOnTick: !0, title: { rotation: 270, text: "Values" }, stackLabels: { enabled: !1, formatter: function() {
                    return w.numberFormat(this.total, -1) }, style: D(ba.line.dataLabels.style, { color: "#000000" }) } },
        ...
        adjustForMinRange: function() {
            var a =
                ...
                f, g, h, i, k, j;
            if (this.isXAxis && this.minRange === z && !this.isLog) r(a.min) || r(a.max) ? this.minRange = null : (o(this.series, function(a) { i = a.xData;
                for (g = k = a.xIncrement ? 1 : i.length - 1; g > 0; g--)
                    if (h = i[g] - i[g - 1], f === z || h < f) f = h }), this.minRange = E(f * 5, this.dataMax - this.dataMin));
        ...
        setExtremes: function(a, b, c, d, e) {
            ...
            e = s(e, { min: a, max: b });
            H(f, "setExtremes", e, function() { f.userMin = a;
                f.userMax = b;
                f.eventArgs = e;
                c && g.redraw(d) }) },
        zoom: function(a, b) {
        ...
        getExtremes: function() {
            var a = this.isLog,
                b = this.lin2log;
            return { min: a ? da(b(this.min)) : this.min, max: a ? da(b(this.max)) : this.max, dataMin: this.dataMin, dataMax: this.dataMax, userMin: this.userMin, userMax: this.userMax } },
        ...
        unsquish: function() {
            var a = this.options.labels,
                ...
                j, l = function(a) { a /= e || 1;
                    a = a > 1 ? ua(a) : 1;
                    return a * c };
            b ? (j = !a.staggerLines && !a.step && (r(g) ? [g] : e < p(a.autoRotationLimit, 80) && a.autoRotation)) && o(j, function(a) {
                var b;
                if (a === g || a && a >= -90 && a <= 90) i = l(Q(h.h / aa(ha * a))), b = i + Q(a / 360), b < k && (k = b, f = a, d = i) }) : a.step || (d = l(h.h));
            this.autoRotation = j;
        ...
        renderUnsquish: function() {
            ...
            else if (g && (l = { width: h + "px" }, !j)) { l.textOverflow = "clip";
                for (n = c.length; !f && n--;)
                    if (q = c[n], h = d[q].label)
                        if (h.styles.textOverflow === "ellipsis" ? h.css({ textOverflow: "clip" }) : d[q].labelLength > g && h.css({ width: g + "px" }), h.getBBox().height > this.len / c.length - (k.h - k.f)) h.specCss = { textOverflow: "ellipsis" } }
        ...
        render: function() {
            ...
            if (a.hasData() || g) {
                a.minorTickInterval && !a.categories && o(a.getMinorTickPositions(), function(b) { j[b] || (j[b] = new Va(a, b, "minor"));
                ...
                n && o(h, function(c, d) { s = h[d + 1] !== z ? h[d + 1] + q : a.max - q;
                    if (d % 2 === 0 && c < a.max && s <= a.max + (b.polar ? -q : q)) l[c] || (l[c] = new w.PlotLineOrBand(a)), t = c + q, l[c].options = { from: e ? f(t) : t, to: e ? f(s) : s, color: n }, l[c].render(), l[c].isActive = !0 });
            ...
            if (v) p = a.getLinePath(v), a.axisLine ? a.axisLine.animate({ d: p }) : a.axisLine = c.path(p).attr({ stroke: d.lineColor, "stroke-width": v, zIndex: 7 }).add(a.axisGroup), a.axisLine[x ? "show" : "hide"](!0);
        ...
        destroy: function(a) {
            ...
            o([b.ticks, b.minorTicks, b.alternateBands], function(a) { Ra(a) });
            for (a = e.length; a--;) e[a].destroy();
            o("stackTotalGroup,axisLine,axisTitle,axisGroup,cross,gridGroup,labelGroup".split(","), function(a) { b[a] && (b[a] = b[a].destroy()) });
    ...
    fa.prototype.getTimeTicks = function(a, b, c, d) {
        ...
        if (r(b)) {
            ...
            e.push(d);
            o(Ma(e, function(a) {
                return k <= G.hour && a % G.day === q }), function(a) { f[a] = "day" })
        }
    ...
    fa.prototype.getLogTickPositions = function(a,
        ...
        if (a >= 0.5) a = B(a), i = this.getLinearTickPositions(a, b, c);
            ...
            for (var f = T(b), k, j, l, m, n, e = a > 0.3 ? [1, 2, 4] : a > 0.15 ? [1, 2, 4, 6, 8] : [1, 2, 3, 4, 5, 6, 7, 8, 9]; f < c + 1 && !n; f++) { j = e.length;
                for (k = 0; k < j && !n; k++) l = h(g(f) * e[k]), l > b && (!d || m <= c) && m !== z && i.push(m), m > c && (n = !0), m = l } else if (b = g(b), c = g(c), a = e[d ? "minorTickInterval" : "tickInterval"], a = p(a === "auto" ? null : a, this._minorAutoInterval, (c - b) * (e.tickPixelInterval /
    ...
    fa.prototype.lin2log = function(a) {
        return W.pow(10, a) };
    var Ob = w.Tooltip = function() { this.init.apply(this, arguments) };
    Ob.prototype = {
        init: function(a, b) {
            var c = b.borderWidth,
                d = b.style,
        ...
        move: function(a, b, c, d) {
            ...
            s(f, { x: g ? (2 * f.x + a) / 3 : a, y: g ? (f.y + b) / 2 : b, anchorX: h ? z : g ? (2 * f.anchorX + c) / 3 : c, anchorY: h ? z : g ? (f.anchorY + d) / 2 : d });
            e.label.attr(f);
        ...
        hide: function(a) {
            ...
            if (!this.isHidden) this.hideTimer = Oa(function() { b.label[a ? "fadeOut" : "hide"]();
                b.isHidden = !0 }, a) },
        ...
        getPosition: function(a, b, c) {
            var d = this.chart,
                ...
                q = function() { l.apply(0, i) !== !1 ? m.apply(0, k) === !1 && !h && (n(!0), q()) : h ? f.x = f.y = 0 : (n(!0), q()) };
        ...
        getXDateFormat: function(a, b, c) {
            var d,
                ...
                h, i = "millisecond";
            if (e) { h = Pa("%m-%d %H:%M:%S.%L", a.x);
                for (f in G) {
                    if (e === G.week && +Pa("%w", a.x) === c.options.startOfWeek && h.substr(6) === "00:00:00.000") { f = "week";
                        break }
                    if (G[f] > e) { f = i;
                        break }
    ...
    var Xa = w.Pointer = function(a, b) { this.init(a, b) };
    Xa.prototype = {
        init: function(a, b) {
            var c =
                b.chart,
        ...
        runPointActions: function(a) {
            ...
            g && (e ? g.noSharedTooltip : g.directTouch) && f ? m = [f] : (o(c, function(b) { k = b.noSharedTooltip && e;
                j = !e && b.directTouch;
                b.visible && !k && !j && p(b.options.enableMouseTracking, !0) && (n = b.searchPoint(a, !k && b.kdDimensions === 1)) && l.push(n) }), o(l, function(a) {
            ...
            if (m[0] && (m[0] !== this.prevKDPoint || d && d.isHidden))
                ...
                !d.isHidden && (c = d.getAnchor([{}], a), d.updatePosition({ plotX: c[0], plotY: c[1] }));
            if (!this._onDocumentMouseMove) this._onDocumentMouseMove = function(a) {
                if (O[ga]) O[ga].pointer.onDocumentMouseMove(a) }, N(A, "mousemove", this._onDocumentMouseMove);
            o(e ? l : [p(m[1], f)], function(c) { o(b.axes, function(b) {
        ...
        reset: function(a, b) {
            ...
            if (a) g && h && (g.refresh(h), e && (e.setState(e.state, !0), o(c.axes, function(a) { p(a.crosshair && a.crosshair.snap, !0) ? a.drawCrosshair(null, e) : a.hideCrosshair() })));
            else {
                if (e) e.onMouseOut();
        ...
        drag: function(a) {
            ...
            if (!m || !m.touch)
                if (d < h ? d = h : d > h + k && (d = h + k), e < i ? e = i : e > i + j && (e = i + j), this.hasDragged = Math.sqrt(Math.pow(n - d, 2) + Math.pow(q - e, 2)), this.hasDragged > 10) {
                    ...
                    if (b.hasCartesianSeries && (this.zoomX || this.zoomY) && l && !v && !m) this.selectionMarker = m = b.renderer.rect(h, i, f ? 1 : k, g ? 1 : j, 0).attr({ fill: c.selectionMarkerFill || "rgba(69,114,167,0.25)", zIndex: 7 }).add();
        ...
        drop: function(a) {
            ...
            if (this.selectionMarker) {
                ...
                }), j && H(c, "selection", e, function(a) { c.zoom(s(a, d ? { animation: !1 } : null)) });
        ...
        onDocumentMouseUp: function(a) { O[ga] && O[ga].pointer.drop(a) },
        ...
        setDOMEvents: function() {
            ...
            if (db) b.ontouchstart = function(b) { a.onContainerTouchStart(b) }, b.ontouchmove = function(b) { a.onContainerTouchMove(b) }, eb === 1 && N(A, "touchend", a.onDocumentTouchEnd)
        },
        destroy: function() {
            var a;
    ...
    s(w.Pointer.prototype, {
        ...
        pinchTranslateDirection: function(a, b, c, d, e, f, g, h) {
            var i = this.chart,
                ...
                s = !u && b[1][l],
                z = !u && c[1][l],
                w, c = function() {!u && Q(t - s) > 20 && (p = h || Q(r - z) / Q(t - s));
                    v = (n - r) / p + t;
        ...
        touch: function(a, b) {
            ...
            if (a.touches.length ===
                ...
                if (a = this.normalize(a), c.isInsidePlot(a.chartX - c.plotLeft, a.chartY - c.plotTop) && !c.openMenu) { b && this.runPointActions(a);
                    ...
                    p(d, !0) && this.pinch(a) } else b && this.reset();
        ...
        onDocumentTouchEnd: function(a) { O[ga] && O[ga].pointer.drop(a) }
    });
    if (C.PointerEvent ||
        C.MSPointerEvent) {
        var va = {},
            ...
            Rb = function() {
                ...
                return b },
            Db = function(a, b, c, d) {
                if ((a.pointerType === "touch" || a.pointerType === a.MSPOINTER_TYPE_TOUCH) && O[ga]) d(a), d = O[ga].pointer, d[b]({ type: c, target: a.currentTarget, preventDefault: Aa, touches: Rb() }) };
        s(Xa.prototype, {
            ...
            onContainerPointerMove: function(a) { Db(a, "onContainerTouchMove", "touchmove", function(a) { va[a.pointerId] = { pageX: a.pageX, pageY: a.pageY };
                    if (!va[a.pointerId].target) va[a.pointerId].target = a.currentTarget }) },
            onDocumentPointerUp: function(a) { Db(a, "onDocumentTouchEnd", "touchend", function(a) { delete va[a.pointerId] }) },
        ...
        fb(Xa.prototype, "init", function(a, b, c) { a.call(this, b, c);
    ...
    var pb = w.Legend = function(a, b) { this.init(a, b) };
    pb.prototype = {
        init: function(a, b) {
            var c = this,
                d = b.itemStyle,
                e = b.itemMarginTop || 0;
            this.options = b;
            if (b.enabled) c.itemStyle = d, c.itemHiddenStyle = D(d, b.itemHiddenStyle), c.itemMarginTop = e, c.padding = d = p(b.padding, 8), c.initialItemX = d, c.initialItemY = d - 5, c.maxItemWidth = 0, c.chart = a, c.itemHeight = 0, c.symbolWidth = p(b.symbolWidth, 16), c.pages = [], c.render(), N(c.chart, "endResize", function() { c.positionCheckboxes() }) },
        ...
        renderItem: function(a) {
            ...
            if (!o) {
                ...
                a.legendItem = o = c.text("", l ? f + g : -g, this.baseline || 0, u).css(D(a.visible ? h : i)).attr({ align: l ? "left" : "right", zIndex: 2 }).add(a.legendGroup);
        ...
        render: function() {
            ...
            if (l || m) {
                if (i) {
                    if (g > 0 && h > 0) i[i.isNew ? "attr" : "animate"](i.crisp({ width: g, height: h })), i.isNew = !1 } else a.box = i = c.rect(0, 0, g, h, k.borderRadius, l || 0).attr({ stroke: k.borderColor, "stroke-width": l || 0, fill: m || "none" }).add(d).shadow(k.shadow), i.isNew = !0;
                i[f ? "show" : "hide"]() }
            a.legendWidth = g;
            a.legendHeight =
                h;
        ...
        handleOverflow: function(a) {
            ...
            if (a > f && k.enabled !== !1) {
                ...
                r(h);
                if (!m) this.nav =
                    m = d.g().attr({ zIndex: 1 }).add(this.group), this.up = d.symbol("triangle", 0, 0, l, l).on("click", function() { b.scroll(-1, j) }).add(m), this.pager = d.text("", 15, 10).css(k.style).add(m), this.down = d.symbol("triangle-down", 0, 0, l, l).on("click", function() { b.scroll(1, j) }).add(m);
                b.scroll(0);
                a = f
    ...
    (/Trident\/7\.0/.test(za) || La) && fb(pb.prototype, "positionItem", function(a, b) {
        ...
        d();
        setTimeout(d) });
    var gb = w.Chart = function() { this.getArgs.apply(this, arguments) };
    ...
    gb.prototype = {
        ...
        redraw: function(a) {
            ...
            i && (o(b, function(a) { a.isDirty && (k = !0) }), o(b, function(a) {
                var b = a.min + "," + a.max;
                if (a.extKey !== b) a.extKey = b, q.push(function() { H(a, "afterSetExtremes", s(a.eventArgs, a.getExtremes()));
                    delete a.eventArgs });
                (k || g) && a.redraw() }));
            k && this.drawChartBox();
        ...
        getAxes: function() {
            ...
            c = c.concat(b);
            o(c, function(b) { new fa(a, b) }) },
        getSelectedPoints: function() {
            var a = [];
            o(this.series, function(b) { a = a.concat(Ma(b.points || [], function(a) {
                    return a.selected })) });
            return a
        },
        ...
        getContainer: function() {
            ...
            d = this.chartWidth;
            e = this.chartHeight;
            this.container = a = $(Ka, { className: "highcharts-container" + (c.className ? " " + c.className : ""), id: f }, s({ position: "relative", overflow: "hidden", width: d + "px", height: e + "px", textAlign: "left", lineHeight: "normal", zIndex: 0, "-webkit-tap-highlight-color": "rgba(0,0,0,0)" },
        ...
        getAxisMargins: function() {
            ...
            o(nb, function(d, e) { r(c[e]) || (a[d] += b[e]) });
            a.setChartSize() },
        reflow: function(a) {
            var b = this,
                c = b.options.chart,
        ...
        initReflow: function() {
            ...
            N(C, "resize", b);
            N(a, "destroy", function() { V(C, "resize", b) }) },
        setSize: function(a, b, c) {
            var d = this,
                e, f, g = d.renderer;
            d.isResizing += 1;
            ...
            H(d, "resize");
            Oa(function() { d && H(d, "endResize", null, function() { d.isResizing -= 1 }) }, $a(a).duration)
        },
        ...
        resetMargins: function() {
            var a = this;
            o(nb, function(b, c) { a[b] = p(a.margin[c], a.spacing[c]) });
        ...
        drawChartBox: function() {
            ...
            if (m) g ? (g.strokeWidth = -m, g.animate(g.crisp({ x: q, y: p, width: o, height: r }))) : this.plotBorder = b.rect(q, p, o, r, 0, -m).attr({ stroke: a.plotBorderColor, "stroke-width": m, fill: "none", zIndex: 1 }).add();
            this.isDirtyBox = !1
        },
        ...
        showCredits: function(a) {
            if (a.enabled && !this.credits) this.credits = this.renderer.text(a.text,
                ...
                if (a.href) C.location.href = a.href }).attr({ align: a.position.align, zIndex: 8 }).css(a.style).add().align(a.position)
        },
        destroy: function() {
            var a = this,
                b = a.axes,
        ...
        isReadyToRender: function() {
            var a = this;
            return !ca && C == C.top && A.readyState !== "complete" || ia && !C.canvg ? (ia ? Nb.push(function() { a.firstRender() }, a.options.global.canvasToolsURL) : A.attachEvent("onreadystatechange", function() { A.detachEvent("onreadystatechange", a.firstRender);
    ...
    var Bb = w.CenteredSeriesMixin = { getCenter: function() {
                var a = this.options,
                    b = this.chart,
    ...
    R.prototype = {
        ...
        bindAxes: function() {
            ...
            o(a.axisTypes || [], function(e) { o(c[e], function(c) { d = c.options;
                    if (b[e] === d.index || b[e] !== z && b[e] === d.id || b[e] === z && d.index === 0) c.series.push(a), a[e] = c, c.isDirty = !0 });!a[e] && a.optionalAxis !== e && Z(18, !0) }) },
        ...
        getCyclic: function(a, b, c) {
            ...
            this[a] = b },
        getColor: function() { this.options.colorByPoint ? this.options.color = null : this.getCyclic("color", this.options.color || ba[this.type].color, this.chart.options.colors) },
        getSymbol: function() {
            var a =
                this.options.marker;
        ...
        setData: function(a, b, c, d) {
            ...
            if (d !== !1 && h && g === h && !e.cropped && !e.hasGroupedData && e.visible) o(a, function(a, b) {
                ...
                if (n && h > n) {
                    ...
                    for (c = 0; c < h; c++)
                        if (a[c] !== z && (j = { series: e }, e.pointClass.prototype.applyOptions.apply(j, [a[c]]), e.updateParallelArrays(j,
                ...
                for (f = b.length; f--;)
                    if (g = b[f], d = T(g.plotX), e = g.plotY, j = g.graphic, n = g.marker || {}, q = !!g.marker, a = r && n.enabled === z || n.enabled, o = g.isInside, a && e !== z && !isNaN(e) && g.y !== null)
                        if (a = g.pointAttr[g.selected ? "select" : ""] || m, h = a.r, i = p(n.symbol, this.symbol), k = i.indexOf("url") ===
                            0, j) j[o ? "show" : "hide"](!0).attr(a).animate(s({ x: d - h, y: e - h }, j.symbolName ? { width: 2 * h, height: 2 * h } : {}));
                        else {
        ...
        drawGraph: function() {
            ...
            o(c, function(c, i) {
                var k = c[0],
                    j = a[k];
                if (j) j.animate({ d: f });
                else if ((d || g) && f.length) j = { stroke: c[1], "stroke-width": d, fill: g, zIndex: 1 }, c[2] ? j.dashstyle = c[2] : e && (j["stroke-linecap"] = j["stroke-linejoin"] = "round"), a[k] = a.chart.renderer.path(f).attr(j).add(a.group).shadow(i <
                    2 && b.shadow)
            })
        },
        applyZones: function() {
            ...
            if (d.length && (i || k) && l.min !== z) i && i.hide(), k && k.hide(), m = l.getExtremes(), o(d, function(d, o) {
                ...
                x = t(e, f);
                if (l.isXAxis) {
                    if (h = { x: q ? x : r, y: 0, width: y, height: j }, !v) h.x = b.plotHeight - h.x } else if (h = { x: 0, y: q ? x : r, width: j, height: y }, v) h.y = b.plotWidth - h.y;
                b.inverted && c.isVML && (h = l.isXAxis ? { x: 0, y: n ? r : x, height: h.width, width: b.chartWidth } : { x: h.y - b.plotLeft - b.spacingBox.x, y: 0, width: h.height, height: b.chartHeight });
        ...
        invertGroups: function() {
            ...
            var b = this,
                c = b.chart;
            if (b.xAxis) N(c, "resize", a), N(b, "destroy", function() { V(c, "resize", a) }), a(), b.invertGroups = a
        },
        ...
        render: function() {
            ...
            e && a.animate();
            if (!h) a.animationTimeout = Oa(function() { a.afterAnimate() }, e);
        ...
        buildKDTree: function() {
            ...
            var b = this,
                c = b.kdDimensions;
            delete b.kdTree;
            Oa(function() { b.kdTree = a(b.getValidPoints(null, !b.directTouch), c, c) }, b.options.kdNow ? 0 : 1)
        },
    ...
    R.prototype.getStackIndicator = function(a, b, c) {!r(a) || a.x !== b ? a = { x: b, index: 0 } : a.index++;
    ...
    s(gb.prototype, {
        ...
        showLoading: function(a) {
            ...
            if (!d) b.loadingDiv =
                d = $(Ka, { className: "highcharts-loading" }, s(e.style, { zIndex: 10, display: "none" }), b.container), b.loadingSpan = $("span", null, e.labelStyle, d), N(b, "redraw", f);
    ...
    var la = oa(R, {
        ...
        getGraphPath: function(a) {
            ...
            for (f = 0; f < a.length; f++)
                if (g = a[f].isNull, j = p(a[f].rectPlotX, a[f].plotX), q = p(a[f].yBottom, n), !g || c) { c || o(f, f - 1, "left");
    ...
    wa = oa(R, {
        ...
        getPointSpline: function(a,
            ...
            var d = b.plotX,
                ...
                c = a[c + 1],
                g, h, i, k;
            if (f && !f.isNull && c && !c.isNull) { a = f.plotY;
                i = c.plotX;
                var c = c.plotY,
                    j = 0;
                g = (1.5 * d + f.plotX) / 2.5;
    ...
    la = la.prototype;
    wa = oa(wa, { type: "areaspline", getStackPoints: la.getStackPoints, getGraphPath: la.getGraphPath, setStackCliffs: la.setStackCliffs, drawGraph: la.drawGraph, drawLegendSymbol: M.drawRectangle });
    I.areaspline = wa;
    ba.column = D(ea, {
        borderColor: "#FFFFFF",
        borderRadius: 0,
    ...
    wa = oa(R, {
        ...
        animate: function(a) {
            var b = this,
                ...
                e = this.chart.inverted,
                f = {};
            if (ca) a ? (f.scaleY = 0.001, a = E(c.pos + c.len, t(c.pos, c.toPixels(d.threshold))), e ? f.translateX = a - c.len : f.translateY = a, b.group.attr(f)) : (f[e ? "translateX" : "translateY"] = c.pos, b.group.animate(f, s($a(b.options.animation), { step: function(a, c) { b.group.attr({ scaleY: c.pos }) } })),
                b.animate = null)
        },
        remove: function() {
            var a = this,
    ...
    I.bar = la;
    ba.scatter = D(ea, { lineWidth: 0, marker: { enabled: !0 }, tooltip: { headerFormat: '<span style="color:{point.color}">\u25cf</span> <span style="font-size: 10px;"> {series.name}</span><br/>', pointFormat: "x: <b>{point.x}</b><br/>y: <b>{point.y}</b><br/>" } });
    la = oa(R, {
        type: "scatter",
        sorted: !1,
        requireSorting: !1,
        ...
        kdDimensions: 2,
        drawGraph: function() { this.options.lineWidth && R.prototype.drawGraph.call(this) }
    });
    I.scatter = la;
    ba.pie = D(ea, {
        borderColor: "#FFFFFF",
        ...
        dataLabels: { distance: 30, enabled: !0, formatter: function() {
                return this.y === null ? void 0 : this.point.name }, x: 0 },
        ignoreHiddenPoint: !0,
        legendType: "point",
        marker: null,
        size: null,
    ...
    ea = {
        ...
        isCartesian: !1,
        pointClass: oa(Ia, {
            init: function() { Ia.prototype.init.apply(this, arguments);
                var a = this,
                    b;
        ...
        translate: function(a) {
            ...
            this.getX = function(b, c) { h = W.asin(E((b - a[1]) / (a[2] / 2 + l), 1));
    ...
    R.prototype.drawDataLabels = function() {
        ...
        if (d.enabled || a._hasPointLabels) a.dlProcessOptions && a.dlProcessOptions(d), k = a.plotGroup("dataLabelsGroup", "data-labels", j && !h ? "hidden" :
            "visible", d.zIndex || 6), j && (k.attr({ opacity: +h }), h || N(a, "afterAnimate", function() { a.visible && k.show();
            ...
            if (j && !h) e.dataLabel = j.destroy();
                ...
                else if (r(i)) { j = { fill: d.backgroundColor, stroke: d.borderColor, "stroke-width": d.borderWidth, r: d.borderRadius || 0, rotation: h, padding: d.padding, zIndex: 1 };
    ...
    R.prototype.alignDataLabel = function(a, b, c, d, e) {
        ...
        if (n) d = s({ x: g ? f.plotWidth - i : h, y: B(g ? f.plotHeight - h : i), width: 0, height: 0 }, d), s(c, { width: k.width, height: k.height }), l ? (o = !1, g = f.renderer.rotCorr(j,
            l), g = { x: d.x + c.x + d.width / 2 + g.x, y: d.y + c.y + d.height / 2 }, b[e ? "attr" : "animate"](g).attr({ align: c.align }), h = (l + 720) % 360, h = h > 180 && h < 360, m === "left" ? g.y -= h ? k.height : 0 : m === "center" ? (g.x -= k.width / 2, g.y -= k.height / 2) : m === "right" && (g.x -= k.width, g.y -= h ? 0 : k.height)) : (b.align(c, null, d), g = b.alignAttr), o ? this.justifyDataLabel(b, c, g, k, d, e) : p(c.crop, !0) && (n = f.isInsidePlot(g.x, g.y) && f.isInsidePlot(g.x + k.width, g.y + k.height)), c.shape && !l && b.attr({ anchorX: a.plotX, anchorY: a.plotY });
    ...
    if (I.pie) I.pie.prototype.drawDataLabels = function() {
        ...
        if (a.visible && (e.enabled || a._hasPointLabels)) {
            ...
            for (F = 2; F--;) {
                ...
                if (M) {
                    ...
                    for (J =
                        ...
                        c = u[1];
                        if (m > 0) {
                            if (x = N.pop(), K = x.i, C = x.y, c > C && H[K + 1] !== null || c < C && H[K - 1] !== null) C = E(t(0, c), d.plotHeight) } else C = c;
            ...
            var b = a.dataLabel;
            if (b && a.visible)(a = b._pos) ? (b.attr(b._attr), b[b.moved ? "animate" : "attr"](a), b.moved = !0) : b && b.attr({ y: -9999 }) }) }, I.pie.prototype.alignDataLabel = Aa, I.pie.prototype.verifyDataLabelOverflow = function(a) {
        var b = this.center,
            c = this.options,
            d = c.center,
            e = c.minSize || 80,
    ...
    s(pb.prototype, {
        ...
        createCheckboxForItem: function(a) { a.checkbox = $("input", { type: "checkbox", checked: a.selected, defaultChecked: a.selected }, this.options.itemCheckboxStyle, this.chart.container);
            N(a.checkbox, "click", function(b) { H(a.series || a, "checkboxClick", { checked: b.target.checked, item: a }, function() { a.select() }) }) }
    });
    ...
    s(gb.prototype, {
        ...
        zoomOut: function() {
            var a = this;
            H(a, "selection", { resetSelection: !0 }, function() { a.zoom() }) },
        zoom: function(a) {
        ...
        setState: function(a, b) {
            ...
            if (!(a === this.state && !b || this.selected && a !== "select" || f[a] && f[a].enabled === !1 || a && (k || h && i.enabled === !1) || a && l.states && l.states[a] && l.states[a].enabled === !1)) {
                ...
                if ((c = f[a] && f[a].halo) && c.size) {
                    ...
                    n.attr(s({ fill: this.color || e.color, "fill-opacity": c.opacity, zIndex: -1 }, c.attributes))[b ? "animate" : "attr"]({ d: this.haloPath(c.size) }) } else n && n.attr({ d: [] });
                this.state = a
            }
        },
        haloPath: function(a) {
    ...
    s(w, {
        ...
        hasBidiBug: Pb,
        isTouchDevice: Lb,
        setOptions: function(a) { S = D(!0, S, a);
            Eb();
            return S },
        addEvent: N,
        removeEvent: V,
